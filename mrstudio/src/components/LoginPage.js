                ...
                <div className="login_container">
                    ...
                    <div className="login_form">
                        ...
                        <div className="head">
                            ...
                            <p>{state.login && "Login with the data you entered during your registration." || "Create your own account for MRstudio."}</p>
                        </div>
                        ...
                        <div className="signup_container">
                            <div className="wrapper">
                                ...
                                <p>{state.login && "Create your own account for MRstudio." || "Login with the data you entered during your registration."}</p>
